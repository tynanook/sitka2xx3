...
'For TTR, only one packet is sent to each device.
    ...
    Dim Edge As Long
    Dim nSiteIndex As Long
    Dim loopstatus As Long 'prev
    Dim fails As Long
    Dim pkt_fails As Long
    
    Dim siteStatus As Long 'trial
    Dim thisSite As Long 'trial
...
'                        Debug.Print "FailCount_Pkts = "; pkt_fails
                   ...
                   patgen_fails(1) = Int(50 - TheHdw.Digital.Patgen.FailCount) 'Allow 50 Match Loop FailCount
                        ...
                        If patgen_fails(1) > 0 Then  'And pkt_sent_count > 0 Then
...
If (TheExec.Sites.ActiveCount = 0 Or TheExec.Sites.ActiveCount >= 2) Then Exit Do
    siteStatus = .SelectNext(loopTop)
Loop
 ...
 TheExec.DataLog.WriteComment ("==================  TX915_CW_PWR =================== ")
    ...
    Case 915000000
        ...
        If TheExec.CurrentJob = "f1-prd-std-rn2903" Then
            ...
            TheExec.Flow.TestLimit I_TX915_CW, 0.035, 0.085, , , scaleMilli, unitAmp, "%2.2f", "I_TX915_CW", , , , , , , , tlForceNone
            TheExec.Flow.TestLimit TxPower915, 15, 25, , , , unitDb, "%2.1f", "TxPower_915", , , , , , , , tlForceNone
        
        ElseIf TheExec.CurrentJob = "q1-prd-std-rn2903" Then
   
            TheExec.Flow.TestLimit I_TX915_CW, 0.034, 0.086, , , scaleMilli, unitAmp, "%2.2f", "I_TX915_CW_qc", , , , , , , , tlForceNone
            TheExec.Flow.TestLimit TxPower915, 14, 26, , , , unitDb, "%2.1f", "TxPower_915_qc", , , , , , , , tlForceNone
    
         End If
        
        
    Case Else      'Dummy for force fail purpose
        TheExec.Flow.TestLimit I_TX915_CW, 0.03, 0.09, , , scaleMilli, unitAmp, "%2.2f", "I_TX915_CW", , , , , , , , tlForceNone
        TheExec.Flow.TestLimit TxPower915, 15, 25, , , , unitDb, "%2.1f", "TxPower_915", , , , , , , , tlForceNone
...
errHandler:
    ...
    Select Case TestFreq
    Case 915000000
        TheExec.Flow.TestLimit I_TX915_CW, 0.02, 0.06, , , scaleMilli, unitAmp, "%2.2f", "I_TX915_CW", , , , , , , , tlForceNone
        TheExec.Flow.TestLimit TxPower915, 15, 25, , , , unitDb, "%2.1f", "TxPower_915", , , , , , , , tlForceNone
  
    Case Else      'Dummy for force fail purpose
        TheExec.Flow.TestLimit I_TX915_CW, 0.02, 0.06, , , scaleMilli, unitAmp, "%2.2f", "I_TX915_CW", , , , , , , , tlForceNone
        TheExec.Flow.TestLimit TxPower915, 15, 25, , , , unitDb, "%2.1f", "TxPower_868", , , , , , , , tlForceNone
