...
End_flag_loop:
 ...
 TheExec.DataLog.WriteComment ("==================  TX868_CW_PWR =================== ")
    ...
    Case 868300000
        ...
        If TheExec.CurrentJob = "f1-prd-std" Then
        ...
        ElseIf TheExec.CurrentJob = "q1-prd-std" Then
...
Do While loopstatus <> loopDone
    ...
    'Site specific code here
            ...
            If patgen_fails_fast(0) = 0 Or patgen_fails_slow(0) = 0 Then 'Empty socket workaround
      ...
      'Site specific code here
            ...
            If patgen_fails_fast(1) = 0 Or patgen_fails_slow(1) = 0 Then 'Empty socket workaround
...
'For TTR, only one packet is sent to each device.
 ...
 On Error GoTo errHandler
    ...
    Debug.Print "rn2483_fsk_pkt_rcv_m_rev..."
